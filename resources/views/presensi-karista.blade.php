...
<body>
  ...
  <div id="form-container">
    <h2>PRESENSI KARISTA</h2>
    <div class="message-container">
      <p class="message" id="message"> Maaf, formulir ini hanya dapat diakses pada hari Kamis pukul 15:30 - 17:00</p>
    </div>
    <form action="https://script.google.com/macros/s/AKfycbxc0xh_aKe7R2iO4qXTgp1zExwFESipoPkjyi0nTZZKQMnEC1K69bbnRSdD7o3ngs_p/exec" method="post" id="presensiForm">
  ...
  <script>
    window.onload = function() {
      ...
      if (currentTime.getDay() !== 4 || currentTime < targetTimeStart || currentTime > targetTimeEnd) {
