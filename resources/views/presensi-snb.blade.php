...
<body>
  ...
  <div id="form-container">
    ...
    <div class="message-container">
      <p class="message" id="message"> Maaf, formulir ini hanya dapat diakses pada hari Selasa dan Rabu pukul 15:30 - 17:00</p>
    </div>
    <form action="https://script.google.com/macros/s/AKfycbyTrFmKZz_tC2Xq1YtUHAIRwjZHCAL_BKRfmEZdrOwFrxn3BR0GiIMgPbDufTdbldl5/exec" method="post" id="presensiForm">
          ...
          <tr>
            ...
            <td>
              <div class="presensi-buttons">
                <button type="button" id="presentBtn" onclick="setPresensi('Present')">Hadir</button>
  ...
  <script>
    window.onload = function() {
      ...
      if (currentTime.getDay() !== 2 && (currentTime.getDay() !== 3) || currentTime < targetTimeStart || currentTime > targetTimeEnd) {
